...
public class RegisterModel : PageModel
{
    ...
    //Este é o construtor que Inicia cada uma destas dependências
    ...
    [BindProperty]
    public InputModel Input { get; set; } //implementado sob a forma de object aqui
    ...
    public async Task<IActionResult> OnPostAsync(string returnUrl = null)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            if (result.Succeeded)
            {
                ...
                //add efature to allow any newly registered user automatically gets assigned to the basic role
